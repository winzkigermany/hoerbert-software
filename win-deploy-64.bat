...
C:\Qt\5.12.5\msvc2017_64\bin\windeployqt.exe ..\Build64\Build\bin\hoerbert.exe --release --force --no-system-d3d-compiler -core -gui -xml -network -concurrent --no-compiler-runtime
