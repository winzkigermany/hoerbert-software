...
C:\Qt\5.15.2\msvc2017\bin\windeployqt.exe ..\Build32\Build\bin\hoerbert.exe --release --force --no-system-d3d-compiler -core -gui -xml -network -concurrent --no-compiler-runtime
