...
set BUILDPATH=C:\Users\rainer\documents\hoerbert\Build32
...
set path="%BUILDPATH%\Build\lib_win_;C:\Qt\5.15.2\msvc2019\bin";%PATH%
...
%xcopyexe% "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Redist\MSVC\14.24.28127\x86\Microsoft.VC142.CRT" "%BUILDPATH%\Build\bin" /s /e /v /Y
if %errorlevel% neq 0 goto :error

%xcopyexe% "C:\Program Files (x86)\OpenSSL-Win32\libcrypto-1_1.dll" "%BUILDPATH%\Build\bin\" /Y
if %errorlevel% neq 0 goto :error

%xcopyexe% "C:\Program Files (x86)\OpenSSL-Win32\libssl-1_1.dll" "%BUILDPATH%\Build\bin\" /Y
if %errorlevel% neq 0 goto :error
